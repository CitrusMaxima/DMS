...
<div id="wrapper">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="active-menu" href="#">领导批示文件表<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a class="active-menu" href="Document1-Add-Admin.jsp">登记</a>
                                </li>
                                <li>
    ...
    <!-- /. NAV SIDE  -->
    <div id="page-wrapper">
        <iframe src="Document1-Add.jsp" width="100%" ; height="100%" ;></iframe>
    </div>
