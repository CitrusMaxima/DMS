...
<div id="wrapper">
            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="active-menu" href="#">主要领导签批文件登记表<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a class="active-menu" href="Document3-Add-Admin.jsp">登记</a>
                                </li>
                                <li>
    ...
    <div id="page-wrapper">
        ...
        <iframe src="Document3-Add.jsp" width="100%" ; height="100%" ;></iframe>
    </div>
