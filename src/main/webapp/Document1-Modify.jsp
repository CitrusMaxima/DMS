                            ...
                            <form class="col s12">
                                ...
                                <div class="row">
                                    <div class="input-field col s4">
                                        <input id="rectime" name="rectime" type="text" value="${file.rectime}" class="Wdate validate" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'deadline\')||\'new Date()\'}'})"/>
